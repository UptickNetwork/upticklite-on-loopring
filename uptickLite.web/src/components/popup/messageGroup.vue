    ...
    export default {
        ...
        methods: {
            async init(value) {
               ...
               let res = await api.home.messageRecordGroup({
                   pageNumber:"1",pageSize:"20",lang:"zh",
                   contractAddress:this.currfriend.fansAddress
               });
            ...
            async subCommit() {
                ...
                let params = {
                    ...
                    lang:"zh",
                    content:this.msgtxt,
                    authenticationAddress:"iaa15k328z4v65qd7tp82fcvrymfmfn6lnkq5ep30c"
                };
