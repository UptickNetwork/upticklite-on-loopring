...
export async function getEcDSASig(
  ...
  switch (type) {
    ...
    case GetEcDSASigType.WithoutDataStruct:
      ...
      console.log("xxl getEcDSASig !! 2 typedData",typedData);
      ...
      console.log("xxl getEcDSASig !! 2.1");
      //console.log("xxl IsMobile ",IsMobile.any());
      console.log("xxl getEcDSASig !! 2.122");
      ...
      console.log("xxl getEcDSASig !! 2.2",signature);
      if (signature?.sig) {
        return {
...
export async function signUpdateAccountWithoutDataStructure(
  ...
  console.log("xxl signUpdateAccountWithoutDataStructure 1");
  const typedData: any = getUpdateAccountEcdsaTypedData(bodyParams, chainId);

  
  console.log("xxl signUpdateAccountWithoutDataStructure 2",[
    typedData,
    bodyParams.owner,
...
export async function signNFTMintWithoutDataStructure(
  ...
  console.log("xxl signNFTMintWithoutDataStructure ##0");
  const typedData: any = getNFTMintTypedData(bodyParams, chainId, web3);

  console.log("xxl signNFTMintWithoutDataStructure ##1");
  const result = await getEcDSASig(
    web3,
    typedData,
    owner,
  ...
  console.log("xxl signNFTMintWithoutDataStructure ##2",result);
  return result;
}
